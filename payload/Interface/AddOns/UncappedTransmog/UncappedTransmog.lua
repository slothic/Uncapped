...
local function BuildFrame()
    ...
    frame:SetScript("OnDragStop", function(self)
        ...
        UncappedTransmogDB.pos = { p, rp, x, y }
    end)
    frame:Hide()
    tinsert(UISpecialFrames, "UncappedTransmogFrame")
    ...
    if UncappedTransmogDB.pos then
        local p, rp, x, y = unpack(UncappedTransmogDB.pos)
...
if UncappedUI then
    ...
    L:Button("Open the collection", function() OpenWindow() end, 160)
